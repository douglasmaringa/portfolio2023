...
const description =
  'This project involved developing a better way for biomedical educators and learners to annotate digital slides together.';
const roles = ['User Research', 'UX Design', 'Interface Design', 'Development'];
