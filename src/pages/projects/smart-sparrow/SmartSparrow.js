...
const description =
  'I worked as the development lead on a major iteration of Smart Sparrow’s product. We took the platform in a bold new direction, focusing on becoming the best tool for learning designers.';
const roles = [
          ...
          >
            <ProjectSectionColumns width="full">
              ...
              <Image
                ...
                alt="A learning Full Stack developer building and deploying an interactive lesson on volcanism using the app."
              ...
              <ProjectSection>
                <ProjectSectionContent>
                  <ProjectTextRow center>
                    ...
                    <ProjectSectionText>
                      The flexibility of the product allowed for us to create engaging
                      interactive experiences as highly configurable plugins that could
                      then be used and manipulated by learning designers.
                    </ProjectSectionText>
                  </ProjectTextRow>
                </ProjectSectionContent>
              </ProjectSection>
